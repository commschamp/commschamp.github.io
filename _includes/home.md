...
- **commsdsl2tools_qt** application. It generates C++ code that implements a
...
- **commsdsl2swig** application. It generates [SWIG](https://www.swig.org/)
interface files to create bindings (glue code) to other high level
programming languages. The generated code depends on the output generated by
the **commsdsl2comms** and requires usage of the external [swig](https://www.swig.org/)
utility for bindings code generation.

- **commsdsl2emscripten** application. It generates class wrappers as well as
[emscripten](https://emscripten.org/) bindings to the protocol definition code
generated by the **commsdsl2comms**. The [emscripten](https://emscripten.org/)
toolchain can be used to compile the protocol definition C++ code into the
WebAssembly as well as generate javascript bindings to it.

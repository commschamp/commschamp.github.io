...
[comms_champion](https://github.com/commschamp/comms_champion) repository.
...
developed using the [COMMS library](https://github.com/commschamp/comms_champion#comms-library).
...
The [COMMS library](https://github.com/commschamp/comms_champion#comms-library) was
...
It uses [COMMS library](https://github.com/commschamp/comms_champion#comms-library)
...
- [How to Use CommsChampion Tools](https://github.com/commschamp/comms_champion/wiki/How-to-Use-CommsChampion-Tools) - 
  explains how to use [CommsChampion Tools](https://github.com/commschamp/comms_champion#commschampion-tools)
